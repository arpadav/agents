...
| `aav-style-items` | Item attributes & structure | §9 inline attrs, §12 tests, §13 field spacing |
...
4. **`aav-style-items`** — fix per-item structure: inline attributes, struct field spacing, tests section.
